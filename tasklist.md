...
9. [ ] Покрытие тестами не менее 99% для ключевых модулей (тесты в tests/, оформление по соглашениям)
10. [ ] Все изменения оформить через pull request с ревью и описанием
...
7. [ ] Документация и тесты (покрытие не менее 99%)
8. [ ] Все изменения через pull request с ревью
