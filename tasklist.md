...
2. [ ] Краткосрочная память: формирование контекста из истории сообщений пользователя/ассистента при каждом запросе к LLM (маст хэв)
3. [ ] Долгосрочная память: хранение всей истории взаимодействий пользователя и возможность поиска/извлечения релевантных сообщений для персонализации и расширенного контекста (маст хэв)
4. [ ] Память реализуется на уровне приложения, а не самой LLM-модели (маст хэв, архитектурное требование)
